...
const headCells = [
  ...
  { id: 'price', numeric: true, disablePadding: false, label: 'Price (per Kilo)' },
  { id: 'availableQuantity', numeric: true, disablePadding: false, label: 'Available Quantity' },
  { id: 'view', numeric: true, disablePadding: false, label: 'View' },
  { id: 'view', numeric: true, disablePadding: false, label: 'Edit' },
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">$123.99/Kg</TableCell>
